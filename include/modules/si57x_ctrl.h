...
class Controller: public RegisterDecoderController {
  ...
  public:
    ...
    /** Resets the device in order to read its startup registers and obtain
     * #fxtal. #fstartup must be set. This function blocks while the startup
     * registers are read. Returns false in case of failure. */
