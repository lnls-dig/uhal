 ...
 * current state of this core's registers, which doesn't actually contain any
 * information about the hardware. This class is the relevant one, because it
 * provides an interface to control an acquisition, and obtain its data.
 *
