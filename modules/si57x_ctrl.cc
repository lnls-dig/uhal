...
Core::Core(struct pcie_bars &bars):
    RegisterDecoder(bars, ref_devinfo, {
        PRINTER("STRP_COMPLETE", "Startup registers status", PrinterType::boolean, "valid", "invalid"),
        PRINTER("CFG_IN_SYNC", "Registers synchronization status", PrinterType::boolean, "values in sync", "values NOT in sync"),
        PRINTER("I2C_ERR", "I2C error status", PrinterType::boolean, "No errors", "I2C error ocurred"),
