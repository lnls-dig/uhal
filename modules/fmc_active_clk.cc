...
Core::Core(struct pcie_bars &bars):
    RegisterDecoder(bars, ref_devinfo, {
        ...
        PRINTER("PLL_STATUS", "AD9510 PLL Status", PrinterType::boolean, "locked", "not locked"),
        PRINTER("CLK_SEL", "Reference Clock Selection", PrinterType::boolean, "clock from FPGA (FMC_CLK line)", "clock from external source (MMCX J4)"),
    }),
