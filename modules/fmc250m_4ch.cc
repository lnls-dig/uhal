...
void Core::decode()
{
    add_general("RST_ADCS",
        rf_get_bit(regs.adc_ctl, WB_FMC_250M_4CH_CSR_ADC_CTL_RST_ADCS));
    add_general("RST_DIV_ADCS",
        rf_get_bit(regs.adc_ctl, WB_FMC_250M_4CH_CSR_ADC_CTL_RST_DIV_ADCS));
    add_general("SLEEP_ADCS",
        rf_get_bit(regs.adc_ctl, WB_FMC_250M_4CH_CSR_ADC_CTL_SLEEP_ADCS));
}
...
void Controller::unset_commands() { regs.adc_ctl = 0; }
